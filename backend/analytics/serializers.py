...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Question
        fields = [
            'id', 'survey', 'text', 'type', 'options', 'is_required',
            'order', 'factor', 'factor_details',
...
class SurveyResponseDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SurveyResponse
        fields = [
            'id', 'question_id', 'question_text', 'answer', 'score',
            'max_points', 'has_scoring', 'submitted_at'
        ]
...
class SurveyResponseSummarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SurveyAssignment
        fields = [
            'id', 'employee_details', 'completed_at', 'total_score', 'responses'
        ]
